<x-layout :title="$title">
    ...
    <section
        class="contact-container grid grid-cols-1 gap-y-9 lg:grid-cols-2 md:gap-x-6 py-24 md:py-28 px-5 justify-center md:px-32 bg-gray-100 dark:bg-[#1212]">
        ...
        <div class="map bg-transparent h-[500px] lg:h-full">
            <iframe
