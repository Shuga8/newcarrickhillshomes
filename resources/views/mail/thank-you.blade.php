...
<html lang="en">
    ...
    <head>
        ...
        <title>Your Message Was Successfull</title>
    ...
    <body style="width: 100%;height:100%;background:#ddd;overflow-y:auto;">
        ...
        <div
            ...
            <h1 style="font-size: 14px;color:#212121;padding: 0px 18px;font-weight:400;margin-bottom:30px;">
                Dear <span class="text-transform:capitalize;">{{ $data['name'] }}</span>,
            </h1>

            <div style="padding:20px 15px;">
                <p
                    style="padding: 10px 10px; margin: 10px auto;background: rgba(46, 2, 99, .8);color: #fff;text-align:left;width:fit-content;font-size:13px;">
                    Your message on "<span style="text-transform: uppercase;">{{ $data['subject'] }}</span>" has been
                    recieved.
                </p>
